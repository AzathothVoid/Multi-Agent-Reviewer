...
def make_jwt(app_id : str = settings.github_app_id, private_key: str | None = None) -> str:
...
def get_installation_token(installation_id: int) -> dict:
    ...
    expires_at_ts = int(datetime.fromisoformat(data["expires_at"].replace("Z", "+00:00")).timestamp())
