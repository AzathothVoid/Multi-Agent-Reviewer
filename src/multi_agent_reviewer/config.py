...
class Settings(BaseSettings):
    ...
    github_client_secret : str = Field(default="", validation_alias="GITHUB_APP_CLIENT_SECRET")
    github_private_key : str = Field(default="", validation_alias="GITHUB_APP_PRIVATE_KEY")
